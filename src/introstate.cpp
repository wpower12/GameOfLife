...
CIntroState CIntroState::m_IntroState;	//Creates the singleton instance of the introstate

void CIntroState::Init()
{
	SDL_Surface* temp = SDL_LoadBMP("golIntro.bmp");
...
void CIntroState::HandleEvents(CGameEngine* game)	//When called within the game class, is called with a 'this'
{
	SDL_Event event;
